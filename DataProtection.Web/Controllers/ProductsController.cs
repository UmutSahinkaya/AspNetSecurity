...
namespace DataProtection.Web.Controllers
{
    ...
    {
        private readonly ExampleSecurityDbContext _context;
        private readonly IDataProtector _dataProtector;

        public ProductsController(ExampleSecurityDbContext context,IDataProtectionProvider dataProtectionProvider)
        {
            _context = context;
            //burası hem coder hemde decoder 
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'ExampleSecurityDbContext.Products'  is null.");
            }
            var product = await _context.Products.FindAsync(id);
            if (product != null)
            {
